...
public class PlayerStatisticsControllerTest {
    ...
    public void getStatsByUserId_returns_HTTP_OK() throws Exception {
        ...
        Mockito.when(statisticsService.getStatsByUserId(USER_1.getId())).thenReturn(stats);
    ...
    public void saveStats_returns_HTTP_CREATED() throws Exception {
        ...
        Mockito.when(statisticsService.saveStats(ArgumentMatchers.any(), ArgumentMatchers.anyLong()))
                .thenReturn(stats);
