...
public class ScoreServiceTest {
    ...
    public void createScore_should_return_score() {
        ...
        Score createdScore = scoreService.addScore(scoreRequest);
    ...
    public void getScoresByUserId_should_return_user_scores_ASC_order() {
        ...
        List<Score> scoreResponse = scoreService.getAllScoresByUserId(userRequest.getId());
    ...
    public void getScoresByCourseId_should_return_user_scores_ASC_order() {
        ...
        List<Score> scoreResponse = scoreService.getAllScoresByCourseId(course.getId());
