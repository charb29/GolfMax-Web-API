...
@Entity
@Table(name = "womenTeesHoleYardages")
public class WomenTeesHoleYardages {
    @Id
    ...
    public WomenTeesHoleYardages() {
    }

    public WomenTeesHoleYardages(long id, WomenTees womenTees, Course course, int hole1Yards, int hole2Yards, int hole3Yards,
