...
public class WomenTees {
    ...
    public WomenTees(long id, double courseRating, double slopeRating, int hole1, int hole2, int hole3,
                     int hole4, int hole5, int hole6, int hole7, int hole8, int hole9, int hole10, int hole11,
                     int hole12, int hole13, int hole14, int hole15, int hole16, int hole17, int hole18, int hole1Yards,
