...
public class ChampionshipTees {
    ...
    public ChampionshipTees(long id, double courseRating, double slopeRating, int hole1, int hole2,
                            int hole3, int hole4, int hole5, int hole6, int hole7, int hole8, int hole9, int hole10,
                            int hole11, int hole12, int hole13, int hole14, int hole15, int hole16, int hole17,
                            int hole18, int hole1Yards, int hole2Yards, int hole3Yards, int hole4Yards, int hole5Yards,
                            int hole6Yards, int hole7Yards, int hole8Yards, int hole9Yards, int hole10Yards,
                            int hole11Yards, int hole12Yards, int hole13Yards, int hole14Yards, int hole15Yards,
